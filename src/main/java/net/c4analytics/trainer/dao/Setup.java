package net.c4analytics.trainer.dao;
...
import net.c4analytics.trainer.source.JSONFileTopics;
import net.c4analytics.trainer.source.JSONFileTruth;
import net.c4analytics.trainer.source.SolrSource;
